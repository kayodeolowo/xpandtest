...
DB_CONTAINER_NAME="xpandtest-mysql"
...
docker run --name $DB_CONTAINER_NAME -e MYSQL_ROOT_PASSWORD=$DB_PASSWORD -e MYSQL_DATABASE=xpandtest -d -p 3306:3306 docker.io/mysql
